  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <!--li>Products</li-->
        <li class="active">Select Schedule</li>
      </ol>
    </section>
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="example1" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <?php  while ($row = $select_doctors_schedule_stmt->fetch()) { ?>
                              <tr>
                                <td><?php echo date('F j, Y', strtotime($row['date'])) ?></td>
                                <td><?php echo $row['available'] ?></td>
                                <td><button class="btn text-white btn-sm selectschedule rounded-0" style="background-color: #03a9f4;color: #fff;" data-toggle="modal" data-target="#selectschedule" data-tbl_appointmentschedule_id="<?php echo $row['tbl_appointmentschedule_id'] ?>">Select</a>
                                </td>
                              </tr>
                              <?php } ?>
                            </tbody>
